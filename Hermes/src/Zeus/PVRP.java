...
public class PVRP {
    ...
    public PVRP(String fileName) {
        //read in the PVRP data
        readPVRPDataFromFile(fileName);
    }

    //read in the data from the requested file
    public int readPVRPDataFromFile(String PVRPFileName) {
        // read in the PVRP data from the listed file and load the information
        ...
        try {
            fis = new FileInputStream(PVRPFileName);
        ...
        if (type != 2) //then it is not an PVRP problem
         {
        ...
        try {
            outputPVRPShipData(type, t, PVRPFileName, "outCust.txt"); //problem type, #days or depots
        } catch (Exception e) {
            System.out.println(
    ...
    public void outputPVRPShipData(int type, int noDepots, String PVRPFileName,
        ...
        try {
            ...
            if (type != 2) {
                System.out.println(
                    "ShipmentLinkedList: Problem file is not an PVRPproblem");
            ...
            out.println("PVRP File        : " + ProblemInfo.fileName);
